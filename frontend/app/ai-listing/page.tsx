    ...
    <div className="flex flex-col items-center mt-20 p-5">
      ...
      <form onSubmit={handleSubmit} className="mb-4">
        <input
          ...
          className="border-2 border-black w-96 p-2 mb-2"
          required
        />
      ...
      {jobPosting.title && (
        <div className="border-2 border-gray-300 p-4 w-96">
          ...
          <button onClick={handleCreateListing} className="bg-green-500 text-white py-2 px-4 rounded mt-2">
            Create Listing
          </button>
        </div>
      )}
